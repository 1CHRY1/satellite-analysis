...
def load_db_config(db_config_path):
    ...
    for key, value in json_db_config.items():
        DB_CONFIG[key] = value
    field_list = ["PG_HOST", "PG_RESOURCE_PORT", "PG_RESOURCE_DB", "PG_USER", "PG_PWD", "MINIO_PORT", "MINIO_IP", "MINIO_ACCESS_KEY", "MINIO_SECRET_KEY", "MINIO_SECURE", "MINIO_IMAGES_BUCKET"]
