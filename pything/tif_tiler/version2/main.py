def createApp():
    ...
    from router import rgb, terrain, oneband, mosaic, no_cloud, no_cloud_with_sensorname, image_visualization, on_the_fly_exploration_mosaic, mosaic_single, edge_image_visualization, image_visualization_backup_0801, for_deployment, deployment_with_nodata_question, deployment_with_nodata_question_backup, image_visualization_without_national_scale
