def createApp():
    ...
    from router import rgb, terrain, oneband, mosaic, no_cloud, no_cloud_with_sensorname, image_visualization, on_the_fly_exploration_mosaic, mosaic_single, image_visualization_backup731
    ...
    app.include_router(image_visualization_backup731.router, tags=["Image Visualization Tiler"], prefix="/image_visualization")
