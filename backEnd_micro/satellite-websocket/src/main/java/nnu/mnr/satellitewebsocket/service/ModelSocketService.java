package nnu.mnr.satellitewebsocket.service;

import jakarta.websocket.OnError;
import lombok.extern.slf4j.Slf4j;
import nnu.mnr.satellitewebsocket.client.ModelingClient;
import nnu.mnr.satellitewebsocket.nettywebsocket.annotations.*;
import nnu.mnr.satellitewebsocket.nettywebsocket.socket.Session;
...
public class ModelSocketService {
    ...
    public void onOpen(Session session, @PathParam(value = "userId") String userId, @PathParam(value = "projectId") String projectId) {
        if ( !modelingClient.validateProject(userId, projectId) ) {
