...
export async function searchScenesWithFilter(
    params: SceneSearchRequest,
): Promise<SceneSearchResponse> {
    if (MOCK) return mockSceneSearch
    return client.post<SceneSearchResponse>('/data/scene/sensorId/productId/time/area', params)
}
