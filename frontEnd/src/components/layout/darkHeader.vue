<template>
    <header
      class="flex items-center justify-between border-b-2 border-sky-600 px-10 py-2 shadow-md select-none">
      <div class="flex flex-3/5 items-center justify-start">
        <div class="flex items-center">
          ...
          <span
            class="ml-3 bg-gradient-to-r from-sky-100 to-white bg-clip-text font-semibold whitespace-nowrap text-transparent sm:text-lg md:text-xl lg:text-2xl">卫星中心分析平台</span>
        </div>
