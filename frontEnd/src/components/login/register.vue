            ...
            <div class="right">
                ...
                <div class="form">
                    ...
                    <div class="flex h-[80px] w-[245px] flex-row items-center justify-center">
                        <button type="button" class="submit cursor-pointer" @click="handleRegister">注 册</button>
                        <button type="button" class="submit cursor-pointer" @click="router.push('/login')">返 回</button>
                    </div>
                </div>
            </div>
        </div>
