    ...
    <div>
        ...
        <div class="relative z-99 flex flex-col items-center justify-center">
            <div class="my-10 flex w-[50vw] flex-col items-center justify-center">
                ...
                <div class="searchContainer mt-6 w-[100%]">
                    <div class="model_research">
                        <input type="text" autocomplete="false" placeholder="输入项目名称搜索项目" class="model_research_input"
                            v-model="searchInput" style="font-size: 14px" @keyup.enter="" />
                    ...
                    <el-button type="primary" color="#049f40"
                        style="margin-left: 10px;border-color: #049f40;font-size: 14px;height: 2rem;" @click="">
                        创建
                    </el-button>
                    <el-button type="primary" color="#049f40"
                        style="margin-left: 10px;border-color: #049f40;font-size: 14px;height: 2rem;" @click="">
            ...
            <div class="my-10 flex h-[calc(100vh-264px-56px)] w-full justify-around">
                <projectCard v-for="item in projectList" :project="item" @click="enterProject(item)"></projectCard>
            </div>
        </div>
    </div>
</template>
