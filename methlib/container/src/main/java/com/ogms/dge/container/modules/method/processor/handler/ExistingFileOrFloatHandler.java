...
public class ExistingFileOrFloatHandler implements ParameterHandler {
    ...
    public void parse(Object parameterType, Object rawValue, Integer valIndex, CmdContextDto context, Boolean isExternalCall) throws IOException {
        ...
        if (isNumeric) {
            primitiveTypeHandler.parse("Float", rawValue, valIndex, context, isExternalCall);
        } else {
            ...
            existingFileHandler.parse(parameterType, rawValue, valIndex, context, isExternalCall);
        }
    }
}
