...
public interface IFileInfoService extends IService<FileInfo> {
    ...
    List<String> handleSaveToDb(Long userId, String tmpFilePath, String outputFilePath, String fileFrontName, String outputFileRealName, String newFilePid) throws IOException;
